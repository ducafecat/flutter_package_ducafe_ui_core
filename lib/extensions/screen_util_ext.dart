...
extension EdgeInsetsExtension on EdgeInsets {
  /// Creates adapt insets using r [SizeExtensions].
...
extension BorderRadiusExtension on BorderRadius {
  /// Creates adapt BorderRadius using r [SizeExtensions].
...
extension RadiusExtension on Radius {
  /// Creates adapt Radius using r [SizeExtensions].
...
extension BoxConstraintsExtension on BoxConstraints {
  /// Creates adapt BoxConstraints using r [SizeExtensions].
  ...
  /// Creates adapt BoxConstraints using h-w [SizeExtensions].
